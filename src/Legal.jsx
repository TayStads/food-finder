...
By creating an account or using Food Finder ("the Service"), you agree to be bound by these Terms and Conditions. If you do not agree, please do not use the Service.

2. DESCRIPTION OF SERVICE
Food Finder is a web-based application that helps users discover recipes based on available ingredients. Paid subscribers gain access to a personal recipe repository where they may store and manage their own recipes.

3. USER ACCOUNTS
You must provide accurate information when registering. You are responsible for maintaining the confidentiality of your password and for all activity under your account. Notify us immediately of any unauthorised use at support@foodfinder.app.

4. SUBSCRIPTION PLANS AND BILLING
Food Finder offers the following plans:
- Free: Access to 15 built-in recipes. No payment required.
- 6-Month Plan: R35/month, billed monthly for 6 months (R210 total). Includes full feature access.
- 12-Month Plan: R20/month, billed monthly for 12 months (R240 total). Includes full feature access.
- Annual Plan: R199 billed once per year. Includes full feature access. Saves R41 versus the 12-Month Plan.

All payments are processed securely by PayFast. By subscribing to a paid plan, you authorise Food Finder to charge your chosen payment method on a recurring basis (where applicable) for the selected billing period.
...
You retain ownership of any custom recipes you add to the Service. By adding content, you grant Food Finder a non-exclusive licence to store and display that content for the purpose of providing the Service to you. We do not share your private recipes with other users without your consent.
...
All built-in content, branding, design, and software of Food Finder are the property of Food Finder and are protected under applicable intellectual property laws. You may not copy or reproduce any part of the Service without written permission.
...
To the maximum extent permitted by South African law, Food Finder shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Service.
...
13. CONTACT
For any queries regarding these Terms, contact us at support@foodfinder.app.
`.trim();
...
Food Finder is committed to protecting your personal information in accordance with the Protection of Personal Information Act 4 of 2013 (POPIA) and applicable data protection principles.

1. WHO WE ARE
Food Finder ("we", "us") is the responsible party for personal information collected through this Service. Contact: support@foodfinder.app.
...
To exercise any of these rights, contact us at support@foodfinder.app.
...
9. COOKIES
Food Finder uses essential session cookies to maintain your login state. We do not use advertising or tracking cookies.
...
For data-related queries or complaints: support@foodfinder.app.
